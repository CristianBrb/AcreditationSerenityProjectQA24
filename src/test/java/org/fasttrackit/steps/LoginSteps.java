...
public class LoginSteps {
    ...
    public void verifyUserGetInAndOut(){
        navigateToLoginPage();
        setCredentials(Constants.UserEmail,Constants.UserPassword);
        clickLogin();
        checkLoggedIn("Hello brbcrs (not brbcrs? Log out)\n" +
    ...
    public void forgotYourPass(){
        ...
        navigateToLoginPage();
        setRegisterCredentials(email+domain,Constants.UserPassword);
        loginPage.clickLogout();
